...
> ✅ `SONAR_TOKEN` **no es necesario**. El workflow genera un token temporal automáticamente usando `admin:Admin123456!!` y `http://app-reservas-sonarqube:9000` va hardcodeado.
